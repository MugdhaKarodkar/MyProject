...
<!-- navigation bar -->
	...
	<center>
		<div style="color: teal; font-size: 30px">Update Product</div>

		<form:form modelAttribute="product" method="post" action="update_product"
			...
			<table width="400px" height="150px">
				...
				<tr>
					...
					<c:choose>
						<c:when test="${!empty productObject.id}">
							<td><form:input path="id" value="${productObject.id}"
									readonly="true" /></td>
						</c:when>
						<c:otherwise>
				...
				<tr>
					...
					<td><form:input path="name" value="${productObject.name}"
							required="true" /></td>
				</tr>
				...
				<tr>
					...
					<td><form:input path="price" value="${productObject.price}"
							required="true" /></td>
