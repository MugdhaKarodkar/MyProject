...
<!-- grid ends-->
	...
	<sql:query var="pr" dataSource="${dataSource}">
        SELECT * FROM product where category_id='01';
    </sql:query>

	<div align="center">
		<table border="1" cellpadding="5">
			<caption>
				<h2>Collection of Bangles</h2>
			</caption>
			<tr>
				<th>ID</th>
				<th>Name</th>
			...
			<c:forEach var="product" items="${pr.rows}">
				<tr>
					...
					<td><a href="showcart?product.id=${product.id}">Add to cart</a></td>
<!-- 					<td><a href="showcart1">Add to cart</a></td> -->
				</tr>
			</c:forEach>
		</table>
	</div>
